/*
 Basic Primitives Diagram v3.6.6
...
c.addSegment(new primitives.common.QuadraticArcSegment(u?q.right()+v*(y?-1:1):q.left()-v*(y?-1:1),q.verticalCenter(),u?d.right():d.left(),d.verticalCenter()-v));A&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),w.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(m=f=u?3:7,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(n.x,n.y,u?q.right():q.left(),q.verticalCenter(),r.x,r.y,0.5),z=new primitives.common.Rect(i.x+(u?
...
d.y,d.width,d.height,z.width,z.height,j,m)}null!=p&&p(z)};primitives.common.ConnectorStraight=function(){};primitives.common.ConnectorStraight.prototype=new primitives.common.BaseShape;
primitives.common.ConnectorStraight.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,m,p){var t,q,n,r,s,v=e/2,u=null,y=0,z=0,w=this;r=new primitives.common.Vector(c.centerPoint(),d.centerPoint());c.loopEdges(function(a,b){t=a.getIntersectionPoint(r,!0,1);y=b;return null!=t});d.loopEdges(function(a,b){q=a.getIntersectionPoint(r,!0,1);z=b;return null!=q});if(null!=t&&null!=q){var A=new primitives.common.Vector(t,q);m.getOffset(A,function(c,d,e){A.offset((c*f-(d-1)*f/2)*e);t=A.from;q=A.to;switch(i){case 1:s=
...
c=f.trim(c,g);var i=c.x,s=c.y;f=d.x;d=d.y;for(var v=g,g=new primitives.common.Polyline(j),u,y,e=[new primitives.common.Point(e,-v/2),new primitives.common.Point(0,0),new primitives.common.Point(e,v/2),new primitives.common.Point(3*(e/4),0)],z=Math.atan2(s-d,i-f),i=0,s=e.length;i<s;i+=1)v=e[i],u=v.x*Math.cos(z)-v.y*Math.sin(z),y=v.x*Math.sin(z)+v.y*Math.cos(z),v.x=u+f,v.y=y+d;g.addSegment(new primitives.common.MoveSegment(e[0].x,e[0].y));g.addSegment(new primitives.common.LineSegment(e[1].x,e[1].y));
...
primitives.common.Vector.prototype._contains=function(a,b,c){var d=Math.min(this.from.x,this.to.x),e=Math.min(this.from.y,this.to.y),f=Math.max(this.from.x,this.to.x),g=Math.max(this.from.y,this.to.y);return d-c<=a&&a<=f+c&&e-c<=b&&b<=g+c};primitives.common.Graphics=function(a){this.m_element=a;this.m_placeholders={};this.m_activePlaceholder=null;this.m_cache=new primitives.common.Cache;this.graphicsType=null;this.debug=this.hasGraphics=!1};
...
k.fromItem));return a.SKIP}));for(l in d)if(d.hasOwnProperty(l)){e=d[l];e.sort(function(a,b){return b.toItems.length-a.toItems.length});for(m=0;m<e.length;m+=1){k=e[m];for(var p=a,t=c,q=k.fromItem,n=k.toItems,r=void 0,s=!0,v=null,u=void 0,y=void 0,z=void 0,w=void 0,A=[],y=0,z=n.length;y<z;y+=1)if(u=n[y],r=t.edge(q,u),null!=r){if(null==v)v=r.getFar(u);else if(v!=r.getFar(u)){s=!1;break}A.push(r.getNear(u))}else{s=!1;break}if(s&&(w=new primitives.famdiagram.FamilyItem({id:k.id,isVisible:!0,isLevelNeutral:!0,
isActive:!1,itemConfig:k}),p.bundleParents(v,A,w.id,w)?(w.levelGravity=2,s=!0):p.bundleChildren(v,A,w.id,w)?(w.levelGravity=1,s=!0):p.bundleParents(v,n,w.id,w)?(w.levelGravity=2,s=!0):p.bundleParents(v,n,w.id,w)&&(w.levelGravity=1,s=!0),s)){y=0;for(z=n.length;y<z;y+=1)u=n[y],r=t.edge(q,u),r.setFar(u,w.id)}}}}}var d=null,e=null;return{process:function(f){var g=b.getLogicalFamily(),h=a.getAnnotations(),g=g.clone();c(g,h);d=g;e=a.getMaximumId();if(f&&!g.validate())throw"References are broken in family structure!";
...
primitives.famdiagram.OrgTreeTask=function(a,b){function c(a){var b,c,g,k,m,u,p,z,w=[],A,D,x,F,B,C,G,H,M,E,K,N=[],L;if(0<a.hasNodes()){K={};D=0;L=[];a.loopRoots(this,function(b){var c=x=new primitives.famdiagram.Family(D),d,f=[],e,g,b=a.node(b),f=i(b.id,null,c.id,b.level,b.itemConfig);f.hideParentConnection=!0;f.isVisible=b.isVisible;f.isActive=b.isActive;f.hideParentConnection=b.hideParentConnection;f.hideChildrenConnection=b.hideChildrenConnection;c.items.push(f);K[b.id]=!0;b.familyId=c.id;for(f=
h(b,a,K,c);0<f.length;){e=[];b=0;for(d=f.length;b<d;b+=1)g=f[b],e=e.concat(h(g,a,K,c));f=e}N.push(x);L.push(x);D+=1});L.sort(function(a,b){var c=a.items[0].level,d=b.items[0].level;return c!=d?c-d:b.items.length-a.items.length});w=[];A={};if(0<N.length){m=primitives.common.graph();b=0;for(c=N.length;b<c;b+=1){x=N[b];g=0;for(k=x.links.length;g<k;g+=1)u=x.links[g],z=a.node(u.fromItem).familyId,p=a.node(u.toItem).familyId,z!=p&&(m.addEdge(z,p,{weight:0}),m.edge(z,p).weight+=1),N[p].backLinks.push(new primitives.famdiagram.FamLink(u.toItem,
u.fromItem))}for(;w.length<N.length;){b=0;for(c=L.length;b<c;b+=1)x=L[b],A.hasOwnProperty(x.id)||(M=m.getSpanningTree(x.id,function(a,b){return a.weight-b.weight}),null!=M.node(x.id)?(M.loopPostOrder(this,function(a,b,c){var b=N[a],d=N[c],f=[];null!=c&&(d.familyPriority+=b.familyPriority);f=[];M.loopChildren(this,a,function(a){f.push(a)});f.sort(function(a,b){return N[a].familyPriority-N[b].familyPriority});M.arrangeChildren(a,f)}),M.loopPreOrder(this,function(a){w.push(a);A[a]=!0})):(w.push(x.id),
A[x.id]=!0))}}j.maximumId+=1;z=i(j.maximumId,null,null,l-1,null);z.hideParentConnection=!0;z.hideChildrenConnection=!0;z.title="internal root";z.isVisible=!1;z.isActive=!1;z.childIndex=0;k={};b=0;for(c=w.length;b<c;b+=1){x=N[w[b]];G={};m=z;H=0;p=x.links.concat(x.backLinks);for(g=0;g<p.length;g+=1)u=p[g],B=j.orgTree.node(u.toItem),j.orgTree.node(u.fromItem),!0===k[B.familyId]&&(F=x.items[0],C=B,C.level>=F.level&&j.orgTree.loopParents(this,C.id,function(a,b){C=b;if(b.level<F.level)return!0}),G[C.id]=
G.hasOwnProperty(C.id)?G[C.id]+1:1,H<G[C.id]&&(m=C,H=G[C.id]));g=x;u=void 0;p=g.items[0];B=null;B=m;for(u=m.level+1;u<p.level;u+=1)j.maximumId+=1,B=i(j.maximumId,B.id,null,u,null),B.title="shift",B.isVisible=!1,B.isActive=!1,B.hideParentConnection=!0,B.hideChildrenConnection=!0,g.items.push(B);p.hideParentConnection=!0;j.orgTree.adopt(B.id,p.id,p);k[x.id]=!0}b={};for(E in j.orgPartners)if(j.orgPartners.hasOwnProperty(E)){c=j.orgTree.node(E);z=j.orgPartners[E];k=0;for(m=z.length;k<m;k+=1)g=j.orgTree.node(z[k]),
f(b,g,c)}E=d();e(j.orgTree,b,E)}}function d(){var a={};j.orgTree.loopPostOrder(this,function(b,c,d){l=null!=l?Math.min(l,c.level):c.level;m=null!=m?Math.max(m,c.level):c.level;if(null!=d&&(a[d]||(a[d]={}),c=c.level-1,a[d][c]=a[d][c]?a[d][c]+1:1,null!=a[b]))for(c in a[b])a[b].hasOwnProperty(c)&&(a[d][c]=a[d][c]?a[d][c]+a[b][c]:a[b][c])});return a}function e(a,b,c){var d,f,e,g,h,k,j,i,l,m,p;a.loopLevels(this,function(B,C){var G=primitives.common.graph(),H={},M=null,E;j=[];a.loopChildren(this,C.id,function(c,
e,g){var j;null==M&&(M=e);H[e.id]={};if(b.hasOwnProperty(e.id))for(j in k=b[e.id],k)if(k.hasOwnProperty(j)){m=k[j];H[e.id][j]={};d=0;for(f=m.length;d<f;d+=1)h=m[d],E=h.commonParent==C.id?h.toParent:a.node(h.fromParent).childIndex<a.node(h.toParent).childIndex?"__right__":"__left__",e.id!=E&&(G.addEdge(e.id,E,{weight:0}),G.edge(e.id,E).weight+=1,null==H[e.id][j][E]&&(H[e.id][j][E]=0),H[e.id][j][E]+=1)}0<g&&G.addEdge(e.id,M.id,{weight:0})});if(null!=M){p=G.getGrowthSequence(function(a){return a.weight});
0===p.length&&(p=[M.id]);var K=p,N=[],L,I,Q,S,W,aa,V,O,T,P,R,J,X,da,ga,U,ba,ea,$,Z;I=new primitives.famdiagram.Slots;I.add(new primitives.famdiagram.Slot("__left__"));I.add(new primitives.famdiagram.Slot(null));I.add(new primitives.famdiagram.Slot("__right__"));Q=0;I.loop(function(a){Q+=1;a.position=Q});for(L=0;L<K.length;L+=1)if(S=K[L],"__left__"!=S&&"__right__"!=S)for(ba in T=O=V=aa=W=null,I.loop(function(a){var b,d,f,e;if(null==a.itemId){da=c[S];X=J=R=P=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&
(da&&null!=da[b]&&(P+=a.crossings[b]*da[b]),X+=a.crossings[b]);for(b in H[S])if(H[S].hasOwnProperty(b))for(d in f=H[S][b],f)f.hasOwnProperty(d)&&(e=I.getSlot(d),null!=e&&(e.position<a.position?(P+=(a.left[b]||0)-(e.left[b]||0),J+=Math.abs(e.balance+1)):(P+=(a.right[b]||0)-(e.right[b]||0),J+=Math.abs(e.balance-1)),R+=Math.abs(e.position-a.position)));if(null==aa||aa>P||aa==P&&(V>R||V==R&&(O>J||O==J&&T>X)))aa=P,W=a,V=R,O=J,T=X}}),ga=W.clone(),U=W.clone(),U.itemId=S,I.insertBefore(W,ga),I.insertBefore(W,
U),Q=U.position=0,I.loop(function(a){var b,d;if(a.id!=U.id){d=c[S];for(b in d)d.hasOwnProperty(b)&&(a.left[b]=a.left[b]?a.left[b]+d[b]:d[b]);Q+=1;a.position=Q}},U),Q=0,I.backwardLoop(function(a){var b,d;if(a.id!=U.id){d=c[S];for(b in c[S])c[S].hasOwnProperty(b)&&(a.right[b]=a.right[b]?a.right[b]+d[b]:d[b]);Q-=1;a.position=Q}},U),H[S])if(H[S].hasOwnProperty(ba))for($ in ea=H[S][ba],ea)ea.hasOwnProperty($)&&(Z=I.getSlot($),null!=Z&&(0>Z.position?(Z.balance+=1,U.balance-=1,I.backwardLoop(function(a){if(a.id!=
U.id)if(a.id!=Z.id)a.crossings[ba]=a.crossings[ba]?a.crossings[ba]+ea[$]:ea[$];else return!0},U)):(Z.balance-=1,U.balance+=1,I.loop(function(a){if(a.id!=U.id)if(a.id!=Z.id)a.crossings[ba]=a.crossings[ba]?a.crossings[ba]+ea[$]:ea[$];else return!0},U))));I.loop(function(a){a=a.itemId;null!=a&&("__left__"!=a&&"__right__"!=a)&&N.push(a)});i=N;e=0;for(g=i.length;e<g;e+=1)l=a.node(i[e]),l.childIndex=e,j.push(l.id)}a.arrangeChildren(C.id,j)})}function f(a,b,c){var d=new primitives.famdiagram.ExtraGravity(b.level),
...
primitives.orgdiagram.DrawBackgroundAnnotationTask=function(a,b,c,d,e,f,g){function h(a,b,c){var d,e,g,h,r,s,v,u,y,z,w;d=0;for(e=a.length;d<e;d+=1)if(w=a[d],null!=w.items&&0<w.items.length){r=new primitives.common.Perimeter(i);r.transform=j;s=new primitives.orgdiagram.BackgroundAnnotationConfig;y=["opacity","lineWidth","borderColor","fillColor","lineType"];g=0;for(h=y.length;g<h;g+=1)z=y[g],r[z]=w.hasOwnProperty(z)?w[z]:s[z];i.activate("placeholder",2);v=[];u={};if(w.includeChildren){g=0;for(h=w.items.length;g<
...
primitives.orgdiagram.DrawConnectorsTask=function(a,b,c,d,e,f,g,h,i,j,k){function l(a){var b=n.activate("placeholder",5),c;v.hasNodes()&&(c=new primitives.common.PolylinesBuffer,u.loopLevels(this,function(d){var f=y[d];u.loopLevelItems(this,d,function(d){var e=v.node(d);m(b.hasGraphics,c,w,e,z[d],f,a)})}),n.polylinesBuffer(c))}function m(a,b,c,d,f,e,g){var k,j,l,m,n,q,A,w,W,aa,V,O,T,P,R=0,J,X=0===s.connectorType,da,ga;P=0<f.partnerConnectorOffset?e.shift+e.connectorShift-e.levelSpace/2*(e.partnerConnectorOffset-
...
f.length;w+=1)m=f[w],v.node(m),q=h.getHighlightPath(m),n=z[m],J=new primitives.orgdiagram.ConnectorPoint(n.actualPosition.horizontalCenter(),n.actualPosition.bottom()),J.isSquared=!0,J.highlightPath=q.partnerHighlightPath,J.connectorStyleType=q.partnerHighlightPath?2:1,J.visibility=n.actualVisibility,l.push(J);f=U;for(w=0;w<f.length;w+=1)m=f[w],v.node(m),q=h.getHighlightPath(m),n=z[m],J=new primitives.orgdiagram.ConnectorPoint(n.actualPosition.horizontalCenter(),n.actualPosition.bottom()),J.isSquared=
!0,J.highlightPath=q.partnerHighlightPath,J.connectorStyleType=q.partnerHighlightPath?2:0,J.visibility=n.actualVisibility,l.push(J);0<l.length&&(l.sort(function(a,b){return a.x-b.x}),v.hasChildren(d.id)||(T=(l[0].x+l[l.length-1].x)/2),b.addInverted(function(b){t(b,c,T,P,l,!0,a,1==s.arrowsDirection)}))}j=[];v.hasChildren(d.id)&&(O=!1,v.loopChildren(this,d.id,function(d,f){A=y[u.getLevelIndex(d)];n=z[d];q=h.getHighlightPath(d);da=c.getPalette(q.highlightPath?2:1);ga=b.getPolyline(da);if(f.connectorPlacement&
8)W=z[u.getPrevItem(d)],r.transformPoints(n.actualPosition.x,A.shift+A.horizontalConnectorsDepth,W.actualPosition.right(),A.shift+A.horizontalConnectorsDepth,!0,this,function(a,c,d,f){p(a,c,d,f,b,ga,n.actualVisibility,W.actualVisibility)});else if(f.connectorPlacement&2)aa=z[u.getNextItem(d)],r.transformPoints(n.actualPosition.right(),A.shift+A.horizontalConnectorsDepth,aa.actualPosition.x,A.shift+A.horizontalConnectorsDepth,!0,this,function(a,c,d,f){p(a,c,d,f,b,ga,n.actualVisibility,aa.actualVisibility)});
else if(f.connectorPlacement&1&&!k){V=!0;if(a)switch(n.actualVisibility){case 2:case 3:V=X}J=new primitives.orgdiagram.ConnectorPoint(n.actualPosition.horizontalCenter()+0,n.actualPosition.top());J.isSquared=V;J.connectorStyleType=q.highlightPath?2:1;J.visibility=n.actualVisibility;j.push(J);R=Math.max(R,J.connectorStyleType);O=O||J.isSquared}}),!k&&0<j.length&&(r.transformPoints(T,P,T,e.shift+e.connectorShift,!0,this,function(a,f,e,h){var k=Math.round(s.elbowDotSize/2),i=c.getPalette(R),m=b.getPolyline(i),
...
e))}):h>j.x?r.transformPoints(j.x,j.y,j.x,j.bottom(),!0,this,function(a,b,c,d){m.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))}):r.transformPoints(j.right(),j.y,j.right(),j.bottom(),!0,this,function(a,b,c,d){m.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))})}g&&4!=i.visibility&&m.addArrow(s.linesWidth,function(b,c){var d;b.mergeTo(a.getPolyline(b.paletteItem));A&&(d=a.getPolyline({fillColor:"#ff0000"}),d.addSegment(new primitives.common.DotSegment(c.x-1,c.y-1,2,2,
1)))})}}var n,r,s,v,u,y,z,w,A=!1;return{process:function(){n=a();r=b.getTransform();s=d.getOptions();v=e.getVisualTree();u=f.getTreeLevels();y=g.getTreeLevelsPositions();z=g.getItemsPositions();w=k.getPaletteManager();n.reset("placeholder",5);l(j);return!1}}};
...
primitives.orgdiagram.DrawHighlightAnnotationTask=function(a,b,c,d,e,f,g,h,i,j,k,l,m){function p(a){var b,c,k,p,A,D,x=!0,F,B=i.getItemPosition(a),C=B.actualPosition;switch(B.actualVisibility){case 2:case 3:case 1:b=g.getItemOptions(a);switch(b.showCallout){case 2:x=!1;break;case 1:x=!1;break;default:x=r.showCallout}x?(t.activate("placeholder",10),q.transformRect(C.x,C.y,C.width,C.height,!0,this,function(g,q,x,E){var q=new primitives.common.Rect(g,q,x,E),g=new primitives.common.Point(q.horizontalCenter(),
q.verticalCenter()),x=e.getOptions().scale,E=new primitives.common.Point(j.getPlaceholderOffset()),C=i.getContentSize(),N=d.getOptimalPanelSize();E.scale(1/x);N.scale(1/x);x=new primitives.common.Rect(E.x,E.y,Math.min(N.width,C.width),Math.min(N.height,C.height));1!=B.actualVisibility||!x.overlaps(q)?(A=!primitives.common.isNullOrEmpty(b.calloutTemplateName)?b.calloutTemplateName:!primitives.common.isNullOrEmpty(b.templateName)?b.templateName:!primitives.common.isNullOrEmpty(r.defaultCalloutTemplateName)?
r.defaultCalloutTemplateName:r.defaultTemplateName,D=h.getTemplate(A,h.DefaultWidgetTemplateName),q=D.templateConfig.itemSize,E=new primitives.common.Rect(g.x,g.y,q.width,q.height),g.y>x.bottom()-x.height/4?(E.y-=q.height/2,E.x=g.x<x.horizontalCenter()?E.x+q.width/4:E.x-(q.width/4+q.width)):(E.y+=q.height/4,E.x-=q.width/2),E.x<x.x?E.x=x.x+5:E.right()>x.right()&&(E.x-=E.right()-x.right()+5),E.y<x.y?E.y=x.y+5:E.bottom()>x.bottom()&&(E.y-=E.bottom()-x.bottom()+5),k=E,c=new primitives.common.Rect(k),
...
primitives.orgdiagram.DrawShapeAnnotationTask=function(a,b,c,d,e,f,g,h){function i(a,b){var c,d,f,e,g,i,y,z,w,A,D,x;switch(h){case 1:c=j.activate("placeholder",3);break;case 2:c=j.activate("placeholder",11)}d=0;for(f=a.length;d<f;d+=1)if(D=a[d],null!=D.items&&0<D.items.length){z=new primitives.common.Rect;e=0;for(g=D.items.length;e<g;e+=1)y=b(D.items[e]),null!=y&&z.addRect(y.actualPosition);if(!z.isEmpty()){i=new primitives.common.Shape(j);y=new primitives.orgdiagram.ShapeAnnotationConfig;w="opacity cornerRadius shapeType offset lineWidth borderColor fillColor lineType labelSize labelOffset labelPlacement zOrderType".split(" ");
e=0;for(g=w.length;e<g;e+=1)A=w[e],i[A]=D.hasOwnProperty(A)?D[A]:y[A];i.position=z;i.orientationType=l.orientationType;i.panelSize=c.size;i.labelTemplate=m;i.hasLabel=null!=D.templateName||null!=D.label;x=new primitives.common.RenderEventArgs;x.context=D;x.templateName=i.labelTemplate;k.transformRect(z.x,z.y,z.width,z.height,!0,this,function(a,b,c,d){a=new primitives.common.Rect(a,b,c,d);i.draw(a,x)})}}}var j,k,l,m;return{process:function(){j=a();k=b.getTransform();l=d.getOptions();m=g.getTemplate();
...
primitives.orgdiagram.BackgroundAnnotationManagerTask=function(a,b,c,d){function e(){var a=new primitives.common.perimeter.Manager,b,c,d,e,h,i,p,z,w,A,D,x,F,B,C;if(!k.isEmpty()&&(p=[],z=[],k.loopLevels(this,function(a){D=A=null;C=l[a];4!=C.actualVisibility&&(p.push(a),F=[],k.loopLevelItems(this,a,function(a){var b=j.node(a);x=m[a];4!=x.actualVisibility&&null!=b&&(null!=D&&g(F,A,D,x),A=D,D=x)}),null!=D&&g(F,A,D,null),z.push(F))}),0<z.length)){w=[];h=[];b=0;for(c=z.length;b<c;b+=1)h=primitives.common.mergeSort([h,
z[b]],null,!0),w.push(h),h=z[b];w.push(primitives.common.mergeSort([z[b-1]],null,!0));h=[];b=0;for(c=w.length;b<c;b+=1){i={};F=w[b];d=0;for(e=F.length;d<e;d+=1)B=F[d],i[B]=d;h.push(i)}d=[];i=B=null;b=0;for(c=p.length;b<c;b+=1)e=p[b],null!=i&&f(d,b-1,h,w,l[B],i,l[i],l[e]),B=i,i=e;null!=i&&f(d,b-1,h,w,l[B],i,l[i],null);a.add(d)}return a}function f(a,b,c,d,f,e,g,i){var l=Math.floor(p.normalItemsInterval/2),w=null!=f?Math.floor(3*(f.shift+f.depth)/7+4*g.shift/7):g.shift-l,A=null!=i?Math.floor(3*(g.shift+
g.depth)/7+4*i.shift/7):g.shift+g.depth+l,D=null,x=null,F,B,C;k.loopLevelItems(this,e,function(f){C=j.node(f);F=m[f];4!=F.actualVisibility&&null!=C&&(null!=x&&h(a,c[b],c[b+1],d[b],d[b+1],w,A,D,x,F,B.id),D=x,x=F,B=C)});null!=x&&h(a,c[b],c[b+1],d[b],d[b+1],w,A,D,x,null,B.id)}function g(a,b,c,d){var f=Math.floor(p.normalItemsInterval/2),b=null!=b?Math.floor(3*b.actualPosition.right()/7+4*c.actualPosition.x/7):c.actualPosition.x-f,c=null!=d?Math.floor(3*c.actualPosition.right()/7+4*d.actualPosition.x/
...
primitives.orgdiagram.ItemsPositionsTask=function(a,b,c,d,e,f,g,h,i,j,k,l,m,p){var t,q,n;function r(a){var b=new primitives.common.Rect(0,0,0,0),c,d,f,e,g;switch(K.orientationType){case 2:case 3:a.invert()}if(!G.isEmpty())switch(I.pageFitMode){case 0:case 4:case 5:c=[new primitives.orgdiagram.LevelVisibility(0,1)];b=s(c,0);break;default:c=[new primitives.orgdiagram.LevelVisibility(0,1)];d=[];switch(I.minimalVisibility){case 2:d.push(2);break;case 0:case 3:case 4:d.push(2),d.push(3)}G.loopLevelsReversed(this,
function(a){var b;for(b=0;b<d.length;b+=1)c.push(new primitives.orgdiagram.LevelVisibility(a,d[b]))});f=s(c,c.length-1);f.addRect(a);f.offset(0,0,5,5);g=e=a=null;b=s(c,0);if(!v(b,f)&&(a=0,b=s(c,c.length-1),v(b,f))){for(g=e=c.length-1;1<e-a;)g=Math.floor((e+a)/2),b=s(c,g),v(b,f)?e=g:a=g;e!==g&&(b=s(c,e))}}return b}function s(a,b){var c,d;t=[];G.loopLevels(this,function(){var a=new primitives.orgdiagram.TreeLevelPosition;a.currentvisibility=1;t.push(a)});for(c=0;c<=b;c+=1)d=a[c],t[d.level].currentvisibility=
d.currentvisibility;z();D();w();c=I.lineLevelShift;var f,e,g,h=d=0;f=8*N.linesWidth;switch(N.arrowsDirection){case 1:d=f;h=0;break;case 2:d=0,h=f}f=0;for(e=t.length;f<e;f+=1)g=t[f],c+=g.setShift(c,A(g.actualVisibility),h,d);return new primitives.common.Rect(0,0,Math.round(y()),Math.round(u()))}function v(a,b){var c=!1;switch(I.pageFitMode){case 1:b.width>=a.width&&(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function u(){var a=t[t.length-
1];return a.shift+a.nextLevelShift}function y(){var a=0,b,c;b=0;for(c=t.length;b<c;b+=1)a=Math.max(a,t[b].currentOffset);return a+=I.normalItemsInterval}function z(){var a=m.getCursorTreeItem();q={};G.loopLevels(this,function(b){var c=t[b];G.loopLevelItems(this,b,function(b,d){var f=new primitives.orgdiagram.TreeItemPosition,e=p.isItemSelected(b)?1:d.visibility,g=l.getTemplateParams(b);f.actualVisibility=0===e?c.currentvisibility:e;f.setSize(a==b,g,I,K);q[b]=f})})}function w(){var a,b,c,d,f,e,h,k,
j,i,l,m,p,u;G.loopLevels(this,function(n){var x=t[n];x.shift=0;x.depth=0;x.partnerConnectorOffset=0;x.actualVisibility=4;h=[];l=i=null;G.loopLevelItems(this,n,function(a,b){var c=q[a];x.depth=Math.max(x.depth,c.actualSize.height);switch(c.actualVisibility){case 2:case 3:case 4:l=!l?c.actualSize.height:Math.min(l,c.actualSize.height);break;default:i=!i?c.actualSize.height:Math.min(i,c.actualSize.height)}x.actualVisibility=Math.min(x.actualVisibility,c.actualVisibility);c=g.getOrgPartners(b.id);(0<
b.partners.length||0<c.length)&&h.push(b)});null==i&&(i=x.depth);null!=l&&l>i&&(i=l);switch(I.verticalAlignment){case 0:x.horizontalConnectorsDepth=i/2;break;case 1:x.horizontalConnectorsDepth=x.depth/2;break;case 2:x.horizontalConnectorsDepth=x.depth-i/2}if(0<h.length){u=primitives.common.pile();a=0;for(b=h.length;a<b;a+=1){f=h[a];n=g.getOrgPartners(f.id);k=f.partners.slice(0);0===k.length&&k.push(f.id);k=k.concat(n);p=m=null;c=0;for(d=k.length;c<d;c+=1)j=q[k[c]],e=j.offset+j.actualSize.width/2,
m=null!=m?Math.min(m,e):e,p=null!=p?Math.max(p,e):e;u.add(m,p,f)}x.partnerConnectorOffset=u.resolve(this,function(a,b,c,d){q[c.id].partnerConnectorOffset=d+1})}})}function A(a){var b=0;switch(a){case 1:b=I.normalLevelShift;break;case 2:b=I.dotLevelShift;break;case 3:case 4:b=I.lineLevelShift}return b}function D(){var a,b;a=0;for(b=t.length;a<b;a+=1)t[a].currentOffset=0;H.loopPostOrder(this,function(a,b){var c=q[a],d=c.actualVisibility,f=G.getLevelIndex(a),f=t[f],d=h.getInterval(0===d?f.currentvisibility:
d)/2,e,g,k,j,i,l,m,p;e=8*N.linesWidth;c.leftPadding=d+(0<f.currentOffset?d*b.relationDegree*I.cousinsIntervalMultiplier:0);c.rightPadding=d;0!=N.arrowsDirection&&(b.connectorPlacement&8&&(c.leftPadding+=e),b.connectorPlacement&2&&(c.rightPadding+=e));c.offset=f.currentOffset+c.leftPadding;f.currentOffset=c.offset+c.actualSize.width+c.rightPadding;if(H.hasChildren(a))if(c=x(b),0<c)B(b,c);else if(0>c&&(c=-c,F(b,c),g=null,k={},i=null,f=H.parent(b.id),null!==f&&(H.loopChildrenReversed(this,f.id,function(a,
c){if(c===b)g=[];else if(null!==g){var d=null,f=[],e,h,l,m;e=E[c.id];void 0===e&&(e=[]);e=e.slice();e.splice(0,0,c.id);h=0;for(l=e.length;h<l;h+=1)m=q[e[h]],f[h]=m.offset+m.actualSize.width+m.rightPadding;e=[];var p;h=M[b.id];void 0===h&&(h=[]);h=h.slice();h.splice(0,0,b.id);l=0;for(m=h.length;l<m;l+=1)p=q[h[l]],e[l]=p.offset-p.leftPadding;h=Math.min(f.length,e.length);for(l=0;l<h&&!(m=e[l]-f[l],d=null!==d?Math.min(d,m):m,0>=m);l+=1);j=Math.floor(d);k[c.id]=j;if(0<j)g.splice(0,0,c);else return i=
c,!0}}),0<g.length))){d=null;if(null!==i){l=[i];l=l.concat(g);l.push(b);d=[[i]];f=1;for(e=l.length;f<e;f+=1)m=l[f-1],p=l[f],2==m.gravity||1==p.gravity?d[d.length-1].push(p):d.push([p])}else d=[g.slice(0)],d[d.length-1].push(b);if(0<d.length){g=d[d.length-1];for(f=g.length-2;0<=f;f-=1)p=g[f],j=k[p.id],c=Math.min(j,c),F(p,c),B(p,c)}l=c/(d.length-1);for(e=d.length-2;0<e;e-=1){m=d[e];for(f=m.length-1;0<=f;f-=1)p=m[f],j=k[p.id],c=Math.min(e*l,Math.min(j,c)),F(p,c),B(p,c)}}})}function x(a){var b=q[a.id],
b=b.offset+b.actualSize.width/2,c=null,d,f,e;if(null===a.visualAggregatorId)switch(d=null,H.loopChildren(this,a.id,function(a,b){d=b;if(d.connectorPlacement&1)return!0}),f=q[d.id],e=null,H.loopChildrenReversed(this,a.id,function(a,b){e=b;if(e.connectorPlacement&1)return!0}),a=q[e.id],L.horizontalAlignment){case 1:c=f.offset+f.actualSize.width/2;break;case 2:c=a.offset+a.actualSize.width/2;break;case 0:c=(f.offset+a.offset+a.actualSize.width)/2}else a=q[a.visualAggregatorId],c=a.offset+a.actualSize.width/
2;return b-c}function F(a,b){var c=q[a.id];c.offset+=b;var d=t[G.getLevelIndex(a.id)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width+c.rightPadding)}function B(a,b){var c,d;H.loopLevels(this,a.id,function(a){c=q[a];c.offset+=b;d=t[G.getLevelIndex(a)];d.currentOffset=Math.max(d.currentOffset,c.offset+c.actualSize.width);return!0})}function C(){G.loopLevels(this,function(a){var b=t[a];G.loopLevelItems(this,a,function(a){q[a].setPosition(b,I,K)})})}q={};t=[];n=null;var G,H,M,E,
K,N,L,I,Q;return{process:function(){var g;I=d.getOptions();K=c.getOptions();N=e.getOptions();L=f.getOptions();G=j.getTreeLevels();H=i.getVisualTree();M=k.getLeftMargins();E=k.getRightMargins();t=[];q={};g=a.getOptimalPanelSize();Q=b.getOptions();g.scale(1/Q.scale);g=new primitives.common.Rect(0,0,g.width,g.height);n=r(g);C();return!0},getTreeLevelsPositions:function(){return t},getItemsPositions:function(){return q},getItemPosition:function(a){return q[a]},getContentSize:function(){return n}}};
...
primitives.orgdiagram.TracePathAnnotationsTask=function(a,b,c,d,e){function f(a,b,c,d,f){var e,h,i,r,s,v,u,y,z,w,A,D={};e=0;for(h=a.length;e<h;e+=1)if(i=a[e],null!=i.items&&0<i.items.length&&(w=i.items.slice(0),s=d.node(w[0]),null!=s&&(1==w.length&&f.loopParents(this,s.id,function(a){c.node(a).isActive&&w.push(a);return f.SKIP}),1<w.length))){i=1;for(r=w.length;i<r;i+=1)if(u=d.node(w[i]),null!=u){z=b.getShortestPath(s.id,u.id,function(a,b,c){return a.getNear(c)});s=1;for(v=z.length;s<v;s+=1)A=b.edge([z[s-
1]],[z[s]]),y=g(D,A.highlightItemId),y.highlightPath=1,A.hasOwnProperty("partnerid")&&(y=g(D,A.partnerid),y.partnerHighlightPath=1);s=u}}return D}function g(a,b){var c=a[b];null==c&&(c=new primitives.orgdiagram.TreeItemHighlightPath,a[b]=c);return c}var h={},i=new primitives.orgdiagram.TreeItemHighlightPath;return{process:function(){var g=e.getNavigationFamily(),k=c.getOrgTree(),i=d.getVisualTree(),m=b.getGraph(),p=a.getAnnotations();h=f(p,m,k,i,g);return!0},getHighlightPath:function(a){return h[a]||
...
primitives.orgdiagram.VisualTreeTask=function(a,b,c,d){function e(a,b,c){var e,g,r,A,D,x,F,B,C,G,H,M,E={},K,N={},L,I,Q,S={},W;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,h){var i,B,F;if(!d&&!h.hasVisibleChildren)return a.SKIP;i=c.node(f);i||(i=t({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},h),c.add(null,f,i));Q=I=0;if(null!=
(x=c.indexOf(f)))I=x,Q=c.countSiblings(f)-x-1;B=[];a.loopChildren(this,f,function(a,b){if(d||b.hasVisibleChildren){e=t({parentId:f,actualItemType:b.itemType},b);switch(i.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:q(i,e),e.connectorPlacement=5,F=t({visibility:4}),c.add(F.id,e.id,e),e=F;case 8:case 2:g=c.parent(f);if(i.connectorPlacement&2)A=l(c,n.navigationFamily,i),c.add(g.id,
e.id,e,A+1),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)D=m(c,n.navigationFamily,i),c.add(g.id,e.id,e,D),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:A=l(c,n.navigationFamily,i);c.add(g.id,e.id,e,A+1);e.connectorPlacement=6;e.gravity=2;break;default:D=m(c,n.navigationFamily,i),c.add(g.id,e.id,e,D),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=i.parentId?q(c.node(i.parentId),e):q(i,e,!0);break;case 2:q(i,e)}break;case 4:q(i,
e),e.connectorPlacement=5,F=t({visibility:4}),c.add(F.id,e.id,e),e=F;case 1:null===i.visualAggregatorId&&p(c,i,!1);switch(b.adviserPlacementType){case 2:c.add(f,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:c.add(f,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&q(i,e);break;case 0:B.push(e);q(i,e);break;case 7:case 6:g=c.parent(f);if(i.connectorPlacement&2)c.add(g.id,e.id,e,I),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)c.add(g.id,e.id,e,c.countChildren(g.id)-
Q),e.connectorPlacement=12,e.gravity=1;else{switch(b.adviserPlacementType){case 2:c.add(g.id,e.id,e,I);e.gravity=2;break;default:c.add(g.id,e.id,e,c.countChildren(g.id)-Q),e.gravity=1}switch(e.actualItemType){case 6:e.connectorPlacement=5;break;case 7:e.connectorPlacement=4}}null!=i.parentId?q(c.node(i.parentId),e):q(i,e,!0)}}});switch(i.actualItemType){case 7:case 8:case 6:break;default:W=[],null!=(g=c.parent(f))&&c.loopChildrenRange(this,g.id,I,c.countChildren(g.id)-Q,function(b,c){if(c.id==f)W.push(c);
else switch(c.actualItemType){case 7:case 8:case 6:a.parentid(c.id)==f&&W.push(c)}}),1<W.length&&(S[f]=W)}E[f]=[];N[f]=[];var r=i,C=h.childrenPlacementType,w=E[f],G=N[f],H,M,K,L,$,Z,ca,Y,fa=4==r.visibility&&0===r.connectorPlacement;switch(b.horizontalAlignment){case 0:case 1:M=3;break;case 2:M=2}0===C&&(C=k(a,r)?0===b.leavesPlacementType?3:b.leavesPlacementType:0===b.childrenPlacementType?2:b.childrenPlacementType);H=r;null!==r.visualAggregatorId&&(H=c.node(r.visualAggregatorId));3==C&&3>B.length&&
(C=2);switch(C){case 2:C=0;for(L=B.length;C<L;C+=1)r=B[C],w=a.node(r.id),c.add(H.id,r.id,r),r.connectorPlacement=(w.hideParentConnection?0:1)|(w.hideChildrenConnection?0:4),0===C&&(r.relationDegree=1);break;case 3:L=Math.min(b.maximumColumnsInMatrix,Math.ceil(Math.sqrt(B.length)));$=Math.ceil(B.length/L);Z=Math.ceil(L/2);for(ca=0;ca<Z;ca+=1){M=H;for(Y=0;Y<$;Y+=1){r=j(B,2*ca,Y,L);C=j(B,2*ca+1,Y,L);void 0===w[Y]&&(w[Y]=[],G[Y]=[]);null!==r&&(0===ca&&(r.relationDegree=1),c.add(M.id,r.id,r),r.connectorPlacement=
(fa?0:2)|4,r.gravity=2,G[Y].push(r));if(null!==r||null!==C)K=t({visibility:4,connectorPlacement:fa?0:5}),c.add(M.id,K.id,K),w[Y].push(K);null!==C&&(c.add(M.id,C.id,C),C.connectorPlacement=(fa?0:8)|4,C.gravity=1,G[Y].push(C));M=K}}2<L&&(H.visualAggregatorId=null);break;case 1:C=0;for(L=B.length;C<L;C+=1){r=B[C];K=t({visibility:4,connectorPlacement:fa?0:5});switch(M){case 2:c.add(H.id,r.id,r);c.add(H.id,K.id,K);r.connectorPlacement=(fa?0:2)|4;r.gravity=2;break;case 3:c.add(H.id,K.id,K),c.add(H.id,r.id,
r),r.connectorPlacement=(fa?0:8)|4,r.gravity=1}w[C]=[K];G[C]=[r];H=K}break;default:throw"Children placement is undefined!";}});a.loopPostOrder(this,function(a){var b=c.node(a),d,e,g;if(null!=b){d=N[a];e=E[a];G=h(c,b);if(0<G&&(b.visualDepth=G+1,null!==b.visualAggregatorId)){r=c.node(b.visualAggregatorId);g=c.hasChildren(r.id);for(x=0;x<G-1;x+=1)r=p(c,r,!g)}g=0;var k=c.parent(b.id),j,l,m;if(null!==k){j=c.indexOf(b.id);for(l=1;null!=(m=c.getChild(k.id,j+l));)if(m.connectorPlacement&8)g=Math.max(g,i(c,
m)),l+=1;else break;for(l=1;null!=(m=c.getChild(k.id,j-l));)if(m.connectorPlacement&2)g=Math.max(g,i(c,m)),l+=1;else break}G=g;if(1<G){b.visualDepth+=G-1;g=c.hasChildren(a);r=b;for(x=0;x<G-1;x+=1)r=p(c,r,!g)}H=[];x=0;for(F=d.length;x<F;x+=1){L=d[x];B=H[x]=0;for(C=L.length;B<C;B+=1)H[x]=Math.max(H[x],i(c,L[B]))}x=0;for(F=H.length;x<F;x+=1)if(M=H[x],1<M){B=0;for(C=e[x].length;B<C;B+=1)if(K=e[x][B],c.hasChildren(K.id))for(G=M;1<G;)K=p(c,K,!1),G-=1}null!=S[a]&&f(c,b,S[a])}})}function f(a,b,c){var d,e,
f,h,i=0,k=[],j,m;e=0;for(f=c.length;e<f;e+=1)d=c[e],i=Math.max(i,d.visualDepth);e=0;for(f=c.length;e<f;e+=1){d=c[e];j=g(a,d);h=1;for(m=d;null!=m.visualAggregatorId;)m=a.node(m.visualAggregatorId),m.connectorPlacement=5,h+=1;for(;h<i;)j=p(a,j,!1),h+=1;k.push(g(a,j).id)}m=g(a,b);if(a.hasChildren(m.id)){j=c[Math.floor(c.length/2)];if(1<c.length&&0===c.length%2){e=a.parent(j.id);f=l(a,n.navigationFamily,j);h=a.getChild(e.id,f).gravity||a.getChild(e.id,f+1).gravity;j=t({visibility:4,connectorPlacement:j.connectorPlacement&
...
primitives.orgdiagram.BaseControl=function(a,b,c,d){function e(a){switch(a){case 1:f(!0,v);break;case 2:a=v;n.layout.forceCenterOnCursor=!1;n.tasks.process("HighlightItemOptionTask",null,a);n.graphics.end();break;default:null!=n.mouse&&n.mouse.destroy();j(n.layout);n.layout.element.find("."+n.name).remove();var a=n.layout,b=n.name,e=new primitives.common.Rect(0,0,a.element.outerWidth(),a.element.outerHeight()),r=new primitives.common.Rect(e),A=a.element.offset(),D;D=jQuery('<div tabindex="0"></div>');
D.css({position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:e.width+"px",height:e.height+"px",padding:"0px","margin-bottom":"0px","margin-right":"0px","margin-top":-A.top+Math.floor(A.top)+"px","margin-left":-A.left+Math.floor(A.left)+"px"});D.addClass(b);e=jQuery("<div></div>");e.css({position:"absolute",overflow:"hidden",top:"0px",left:"0px"});e.addClass(b);e.css(r.getCSS());A=jQuery("<div></div>");A.css({position:"absolute",overflow:"hidden",top:"0px",
left:"0px"});A.addClass("placeholder");A.addClass(b);A.css(r.getCSS());r=jQuery("<div></div>");r.css({position:"absolute",overflow:"visible"});r.addClass("calloutplaceholder");r.addClass(b);r.css({top:"0px",left:"0px",width:"0px",height:"0px"});D.append(e);e.append(A);A.append(r);a.element.append(D);a.scrollPanel=D;a.mousePanel=e;a.placeholder=A;a.calloutPlaceholder=r;n.options.enablePanning&&(n.mouse=new primitives.common.Mouse,n.mouse.init(n.layout.element,{name:n.name,onMouseDrag:k,onMouseStop:l,
...
b){return a.weight>b.weight?1:a.weight==b.weight?b.difference-a.difference:-1}),p.loopLevels(this,function(b,g){e[b].processed=!0;p.loopChildren(this,b,function(h,l){var p=j.edge(b,h),n=null,q,t,C,B,E;e[h].processed=!0;if(1<p.weight){t=p.items.join(",");if(c.hasOwnProperty(t))n=c[t];else{q=a();y[q.id]=q;n=new m;n.id=q.id;n.key=t;t=0;for(C=p.items.length;t<C;t+=1)n.children.push(p.items[t]),n.childrenHash[p.items[t]]=!0;n.children.sort();c[n.key]=n;d[n.id]=n;i[n.id]=n;B=n.children.slice(0);f(this,
g.replacementItem||b,function(a){null!=d[a]&&!n.childrenHash[a]&&(E=!0,f(this,a,function(a){return!n.childrenHash[a]?(E=!1,z):w}),E&&B.push(a));return w});k(g.replacementItem||b,B,n.id,q,v,u,r,s,!1);if(1>=(s[b]||0))g.replacementItem=n.id}if(n.id!=h&&(B=n.children.slice(0),f(this,l.replacementItem||h,function(a){null!=d[a]&&!n.childrenHash[a]&&(E=!0,f(this,a,function(a){return!n.childrenHash[a]?(E=!1,z):w}),E&&B.push(a));return w}),k(l.replacementItem||h,B,n.id,null,v,u,r,s,!1),1>=(s[h]||0)))l.replacementItem=
...
1,n[null]||(delete q[null],delete n[null])),delete r[a],delete s[a],delete v[a],delete u[a],delete y[a])},removeRelation:function(a,b){var d=!1;null!=y[a]&&null!=y[b]&&(d=c(a,b)||c(b,a));return d},node:function(a){return y[a]},loop:d,loopLevels:function(a,c,d){function e(){this.items={};this.minimumLevel=null}function f(a,b,c){var d=p[b];d||(d=new e,p[b]=d);d.addItemToLevel(a,c);w=null==w?c:Math.min(w,c);m[a]=c;k[a]=!0}var g=[],h={},k={},l=[],m={},p={},n,q,t,s,u,w=null;t=c?i:j;var z,V,O,T,P,R,J,X;
e.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){t(this,function(a,b,c){g.push(a);h[a]=c});t=0;for(z=g.length;t<z;t+=1)if(n=g[t],null==k[n]){l.push(n);for(f(n,t,0);0<l.length;){P=T=O=null;R=!c;J=[];n=0;for(s=l.length;n<s;n+=1)u=l[n],V=m[u],X=!1,c?(b(this,v,u,function(a){var b;if(!k[a]&&(X=!0,b=h[a],null==O||!R||O<b||O==b&&P>V-1))O=b,T=a,P=V-1,R=!0}),b(this,r,u,function(a){var b;
if(!k[a]&&(X=!0,b=h[a],null==O||!R&&(O>b||O==b&&P<V+1)))O=b,T=a,P=V+1,R=!1})):(b(this,r,u,function(a){var b;if(!k[a]&&(X=!0,b=h[a],null==O||R||O<b||O==b&&P<V+1))O=b,T=a,P=V+1,R=!1}),b(this,v,u,function(a){var b;if(!k[a]&&(X=!0,b=h[a],null==O||R&&(O>b||O==b&&P>V-1)))O=b,T=a,P=V-1,R=!0})),X&&J.push(u);null!=T&&(J.push(T),f(T,t,P));l=J}}l=!0;for(c=w;l;){n={};l=!1;for(q in p)if(p.hasOwnProperty(q)&&(t=p[q],s=t.items[t.minimumLevel-w+c],null!=s)){n[q]=t;l=!0;t=0;for(z=s.length;t<z;t+=1)if(u=s[t],d.call(a,
...
parentsCount:u,nodes:y})},BREAK:z,SKIP:w}};
